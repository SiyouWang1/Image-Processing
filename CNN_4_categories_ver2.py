...
# Image parameters
IMAGE_SIZE = (384, 384)  # Resize images
...
# Update custom generator to work with categorical labels
...
train_generator = datagen.flow_from_directory(
    ...
    class_mode='categorical',  # Binary classification: upright or upsidedown
    subset='training'
)
