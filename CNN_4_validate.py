...
# the upright image
MODEL_PATH = '4_rotations_384_canny_10th_NameChange_No4.h5'  # Path to the trained model
IMAGE_FOLDER = 'C:\\D\\DSU\\Kanagaratnam\\new_val\\Validation 10th sample'  # Path to the folder containing images to predict
